...
from unifier.blocks.custom.r2gen.caption_model import CaptionModel
...
class AttModel(CaptionModel):
    def __init__(self, transformer):
        ...
        self.input_encoding_size = transformer.d_model
        self.rnn_size = transformer.d_ff
        self.num_layers = transformer.num_layers
        self.drop_prob_lm = transformer.drop_prob_lm
        self.max_seq_length = transformer.max_seq_length
        self.att_feat_size = transformer.d_vf
        self.att_hid_size = transformer.d_model

        self.bos_idx = transformer.bos_idx
        self.eos_idx = transformer.eos_idx
        self.pad_idx = transformer.pad_idx

        self.use_bn = transformer.use_bn
    ...
    def _sample(self, fc_feats, att_feats, att_masks=None):
        ...
        for t in range(self.max_seq_length + 1):
            ...
            if t == 0:
                ...
                it[
                    ~unfinished
                ] = self.pad_idx  # This allows eos_idx not being overwritten to 0
