...
from unifier.blocks.huggingface.decoder.beam_search import beam_search
from unifier.blocks.huggingface.decoder.beam_search import prepare_inputs_for_generation
