...
if __name__ == "__main__":
    # # CheXpert Dataset
    # datapath = "/raid/zhouyang/processed_data/CheXpert"
    # csvpath = "/raid/zhouyang/processed_data/CheXpert/chexpert_labels.csv"
    # dataset = CheX_Dataset(data_path=datapath, csvpath=csvpath) 
    # dataset.__getitem__(idx=2)

    # # PadChest
    # # imgpath = "/raid/zhouyang/DATA/PadChest/images-224"
    # imgpath = "/raid/zhouyang/processed_data/PadChest"
    # # csvpath = "/raid/zhouyang/DATA/PadChest/PADCHEST_chest_x_ray_images_labels_160K_01.02.19.csv"
    # csvpath = "/raid/zhouyang/processed_data/PadChest/padchest_labels.csv"
    # dataset = PC_Dataset(data_path=imgpath, csvpath=csvpath) 
    # dataset.__getitem__(idx=3)

    # # OpenI Dataset
    # datapath = "/raid/zhouyang/processed_data/OpenI"
    # dataset = OpenI_Dataset(data_path=datapath)
    # dataset.__getitem__(idx=3)

    # # COVID-19 Dataset
    # imgpath = "/raid/zhouyang/processed_data/COVID-19"
    # csvpath = "/raid/zhouyang/processed_data/COVID-19/covid19_labels.csv"
    # dataset = COVID19_Dataset(data_path=imgpath, csvpath=csvpath)
    # dataset.__getitem__(idx=3)

    # # Object-CXR Dataset
    # imgpath = "/raid/zhouyang/processed_data/Object-CXR/"
    # csvpath = "/raid/zhouyang/processed_data/Object-CXR/object_cxr_labels.csv"
    ...
    # # COVIDx Dataset
    # imgpath = "/raid/zhouyang/processed_data/COVIDx-CXR4"
    # dataset = COVIDx_Dataset(data_path=imgpath) 
    # dataset.__getitem__(idx=3)

    # # VinDr-CXR Dataset
    # imgpath = "/raid/zhouyang/processed_data/Vindr_CXR_512/"
    # csvpath = "/raid/zhouyang/processed_data/Vindr_CXR_512/vindr_labels.csv"
    # dataset = VinDr_Dataset(data_path=imgpath) 
    # dataset.__getitem__(idx=3)

    # # TBX11K Dataset
    # # datapath = "/raid/zhouyang/DATA/tbx11k-simplified/"
    # imgpath = "/raid/zhouyang/processed_data/TBX11K"
    # csvpath = "/raid/zhouyang/processed_data/TBX11K/tbx11k_labels.csv"
    # dataset = TBX11K_Dataset(imgpath=imgpath, csvpath=csvpath) 
    # dataset.__getitem__(idx=2)

    # NIH Dataset
    # datapath = "/raid/zhouyang/DATA/tbx11k-simplified/"
    imgpath = "/raid/zhouyang/processed_data/NIH_ChestX-ray"
    csvpath = "/raid/zhouyang/processed_data/NIH_ChestX-ray/nih_labels.csv"
    dataset = NIH_Dataset(data_path=imgpath, csvpath=csvpath) 
    dataset.__getitem__(idx=2)

    # # RSNA
    # imgpath = "/raid/zhouyang/processed_data/rsna_pneumonia"
    # csvpath = "/raid/zhouyang/processed_data/rsna_pneumonia/rsna_labels.csv"
    # # dicomcsvpath = "/raid/zhouyang/DATA/rsna_pneumonia/stage_2_detailed_class_info.csv"
    # dataset = RSNA_Pneumonia_Dataset(imgpath=imgpath, csvpath=csvpath)
    # dataset.__getitem__(idx=3)

    # # SIIM Dataset
    # imgpath = "/raid/zhouyang/processed_data/siim_acr_pneumothorax"
    # csvpath = "/raid/zhouyang/processed_data/siim_acr_pneumothorax/siim_labels.csv"
    # dataset = SIIM_Pneumothorax_Dataset(imgpath=imgpath, csvpath=csvpath) 
